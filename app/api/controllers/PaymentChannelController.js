...
class PaymentChannelController {
    ...
    async index(req, res, next) {
        try {
            ...
            const {docs, pages, total} = await models.PaymentChannels.paginate(options).then(data => {
    ...
    async show(req, res, next) {
        try {
            ...
            const docs = await models.PaymentChannels.findByPk(req.params.id).then(
                data => {
                    if (data === null) {
    ...
    async create(req, res, next) {
        try {
            ...
            const docs = await models.PaymentChannels.create(req.body);
            let response = {
                data: docs
            }
        ...
        try {
            ...
            const docs = await models.PaymentChannels.findByPk(req.params.id).then(
                data => {
                    ...
                    return models.PaymentChannels.update(req.body, {where: {id: req.params.id}}).then(
                        _data => {
                            if (_data) {
                                return models.PaymentChannels.findByPk(req.params.id);
                            }
        ...
        try {
            ...
            const docs = await models.PaymentChannels.findByPk(req.params.id).then(
                data => {
                    ...
                    return models.PaymentChannels.destroy({where: {id: req.params.id}}).then(
                        _data => {
                            if (_data) {
